'''
Author: Swarnadwip Sarkar
Email: swarnadwipsarkar0@gmail.com
'''
...
def fetch_poster(movie_id):
    ...
    url = "https://api.themoviedb.org/3/movie/{}?api_key=c10775fa899a9ef473772fde971b6952&language=en-US".format(movie_id)
    try:
